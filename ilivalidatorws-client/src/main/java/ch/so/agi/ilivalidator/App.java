                            ...
                            httpRequest.onload = event -> {
                                if (httpRequest.status == 200) {
                                    ...
                                    if (jobStatus.equalsIgnoreCase("SUCCEEDED")) {
                                        ...
                                        String csvLogIconLink = "<a href=\""+csvLogFileHref+"\" target=\"blank\" class=\"badge-link\" download=\""+csvLogFileName+"\">\n"
                                        ...
                                        logToProtocol(messages.validationDone() + ". " + validationStatusTxt +  ": " + txtLogIconLink + "&nbsp;" + xtfLogIconLink + "&nbsp;" + csvLogIconLink);
                                    }
